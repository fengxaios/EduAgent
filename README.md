...
[![Tests](https://img.shields.io/badge/Tests-65_passed-green)](https://github.com/fengxaios/EduAgent/actions)
...
34 pytest unit tests covering agent lifecycle, orchestrator routing, memory persistence, tool registration, and evaluation scoring, plus 31 standalone edge-case tests.
